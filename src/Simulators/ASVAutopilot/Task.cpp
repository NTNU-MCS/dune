  ...
  namespace ASVAutopilot
  {
    ...
    struct Task: public DUNE::Tasks::Periodic
    {
      ...
      task(void)
      {
        ...
        // ASV velocity components, on ground frame
        Matrix vd_gnd_vel = md_rot_body2gnd * vd_body_vel;
        // Relative ASV velocity components, on aircraft frame
        Matrix vd_body_vel_2current = transpose(md_rot_body2gnd) * (vd_gnd_vel - vd_stream_vel);
        ...
        // Absolute speed
        speed.value = vd_body_vel_2current.norm_2();
        /*
