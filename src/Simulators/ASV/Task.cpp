...
namespace Simulators
{
  namespace ASV
  {
    ...
    struct Arguments
    {
      ...
      //! Current velocity parameters (m/s)
      //! - Magnitude
      double Vc;
      //! - Direction
      double Vpsi;
      //! UAV Model Parameters
      std::string sim_type; // Simulation type (3DOF)
      //double gaccel;
      //! - Time constants
      //double c_bank;
      double c_speed;
    ...
    struct Task: public DUNE::Tasks::Periodic
    {
      ...
      Arguments m_args;
      //! Simulation vehicle.
      DUNE::Simulation::ASVSimulation* m_model;
        ...
        m_alias_id(UINT_MAX)
      {
        ...
        param("Current magnitude", m_args.Vc)
        .units(Units::MeterPerSecond)
        .defaultValue("0.0")
        .description("Current speed magnitude in NED frame");

        param("Current direction", m_args.Vpsi)
        .units(Units::MeterPerSecond)
        .defaultValue("0.0")
        .description("Current speed direction in NED frame");
      ...
      onResourceAcquisition(void)
      {
        ...
        if (m_args.sim_type == "3DOF")
        {
          ...
          m_model = new DUNE::Simulation::ASVSimulation(*this, m_position, m_velocity);
        ...
        inf(DTR("ASV simulation type: %s"), m_args.sim_type.c_str());
        // Application of the wind vector
        //m_model->m_wind(0) = m_args.wx;
        //m_model->m_wind(1) = m_args.wy;
        ...
        debug("Initial yaw angle: %1.4f", m_position(3));
        debug("Initial x speed: %1.4f", m_velocity(0));
        debug("Initial y speed: %1.4f", m_velocity(1));
        debug("Initial yaw rate: %1.4f", m_velocity(3));
      ...
      consume(const IMC::DesiredSpeed* msg)
      {
        ...
        m_model->commandSpeed(msg->value);
      ...
      consume(const IMC::DesiredHeading* msg)
      {
        ...
        m_model->commandHeading(msg->value);
      ...
      */
      ...
      commandPrintOut(const IMC::Message* msg, const double* d_msg_value)
      {
        ...
        //  b_cmd_angle = true;
        //}
        if (strcmp(msg_name, "DesiredSpeed") == 0)
        {
          c_units = "m/s";
        }
        else if (strcmp(msg_name, "DesiredHeading") == 0)
        {
          b_cmd_angle = true;
        }
      ...
      task(void)
      {
        ...
        */
        ...
        m_sstate.psi = m_position(2);

        // Rotation matrix
        double euler_ang[3] = {0, 0, m_position(2)};
